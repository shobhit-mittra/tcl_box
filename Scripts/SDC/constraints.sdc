create_clock -name dco_clk -period 1500 -waveform {0 750.0} [get_ports dco_clk]
set_clock_latency -source -rise -min 150 [get_clocks dco_clk]
set_clock_latency -source -fall -min 151 [get_clocks dco_clk]
set_clock_latency -source -rise -max 152 [get_clocks dco_clk]
set_clock_latency -source -fall -max 153 [get_clocks dco_clk]
set_clock_latency -rise -min 154 [get_clocks dco_clk]
set_clock_latency -fall -min 155 [get_clocks dco_clk]
set_clock_latency -rise -max 156 [get_clocks dco_clk]
set_clock_latency -fall -max 157 [get_clocks dco_clk]
create_clock -name lfxt_clk -period 1600 -waveform {0 960.0} [get_ports lfxt_clk]
set_clock_latency -source -rise -min 151 [get_clocks lfxt_clk]
set_clock_latency -source -fall -min 152 [get_clocks lfxt_clk]
set_clock_latency -source -rise -max 153 [get_clocks lfxt_clk]
set_clock_latency -source -fall -max 154 [get_clocks lfxt_clk]
set_clock_latency -rise -min 155 [get_clocks lfxt_clk]
set_clock_latency -fall -min 156 [get_clocks lfxt_clk]
set_clock_latency -rise -max 157 [get_clocks lfxt_clk]
set_clock_latency -fall -max 158 [get_clocks lfxt_clk]
